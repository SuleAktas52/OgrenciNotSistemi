...
public class Student {
    ...
    public void printNote(){
        ...
        System.out.println("Fizik     , Sinav notu : " + this.fizik.note +" , Sozlu notu : "+ this.fizik.verbalNote +"   Oran ==> sinav %75  sozlu %25");
        System.out.println("Kimya     , Sinav notu : " + this.kimya.note +" , Sozlu notu : "+ this.kimya.verbalNote +"   Oran ==> sinav %60  sozlu %40");
    }
